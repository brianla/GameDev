package com.daviancorp.gameobjects;
...
public class ScrollHandler {
	...
	// Constructor receives a float that tells us where we need to 
	// create our Grass and Pipe objects
	...
	// Return true i ANY pipe hits the bird.
